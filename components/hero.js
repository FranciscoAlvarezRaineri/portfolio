          ...
          <div className="max-w-3xl mb-8">
            ...
            <div className="flex flex-col items-start space-y-3 sm:space-x-4 sm:space-y-0 sm:items-center sm:flex-row mt-6">
              <a
                ...
                target="_blank"
                rel="noopener"
                className="flex items-center space-x-2 text-gray-500 dark:text-gray-400 hover:text-indigo-400 dark:hover:text-indigo-400"
              >
                <svg
                  role="img"
                  width="24"
              ...
              <div>
                <a
                  ...
                  className="flex items-center space-x-2 text-gray-500 dark:text-gray-400 hover:text-indigo-400 dark:hover:text-indigo-400"
                >
                  <span className="inline">and my LinkedIn </span>
                  <svg
                    className="inline"
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
